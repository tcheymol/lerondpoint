 ...
 */
final class Version20250326183646 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE collective ADD COLUMN location VARCHAR(255) DEFAULT NULL');
    }
