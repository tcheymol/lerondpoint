 ...
 */
final class Version20250615103549 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE track ADD COLUMN url VARCHAR(2083) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE track ADD COLUMN preview_url VARCHAR(255) DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE track ADD COLUMN video_embed CLOB DEFAULT NULL
        SQL);
    }
}
