 ...
 */
final class Version20250429212111 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE track ADD COLUMN creation_step INTEGER DEFAULT NULL
        SQL);
    }
